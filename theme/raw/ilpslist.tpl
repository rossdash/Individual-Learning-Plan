    ...
    <tr class="{cycle values='r0,r1'}">
        <td>
            <div class="fr ilpstatus">
                 ...
                 <a href="{$WWWROOT}artefact/ilps/ilp.php?id={$ilp->id}" title="{str tag=manageaunits section=artefact.ilps}"><img src="{theme_url filename='images/manage.gif'}" alt="{str tag=manageunits}"></a>
